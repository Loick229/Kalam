...
import type { WritingCard } from "@/lib/types";
...
export default async function LibraryPage() {
  ...
  const { data, error } = await supabase
    .from("writings")
    .select("id, title, subtitle, genre, status, word_count, cover_path, source_format, tags, excerpt, updated_at, created_at")
  ...
  return <Library writings={writings} />;
}
